...
export default function Qu2({  route, navigation }) {
  ...
  const bhandlecheck2 = () => {
    setbCheck(false),setbCheck2(!bcheck2),setbCheck3(false),setbCheck4(false),setState(false)
  }
  const bhandlecheck3 = () => {
